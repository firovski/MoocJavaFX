 ...
 * @author Firas
 */
public class FXMLReponseText5Controller implements Initializable {
 ...
 */
    ...
    public void suivant(ActionEvent event) throws IOException
    {
        ...
        if(chk4.getText().equals(listrep.get(3).getReponsecorrecttext()))
        {
            test=true;
        }
        else
        ...
        if(chk5.getText().equals(listrep.get(4).getReponsecorrecttext()))
        {
            test=true;
        }
        else
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        l4.setText(listrep.get(3).getReponsetext());
        l5.setText(listrep.get(4).getReponsetext());
